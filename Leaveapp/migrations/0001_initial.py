...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': (('can_approve_level1', 'Can approve level 1'), ('can_reject_level1', 'Can reject level 1(unit deparment level level)'), ('can_approve_level2', 'Can approve level 2'), ('can_reject_level2', 'Can reject level 2(division level)'), ('can_approve_level3', 'Can approve level 3'), ('can_reject_level3', 'Can reject level 3(directorat level)')),
            },
        ),
        migrations.CreateModel(
            name='OrgUnit',
            fields=[
                ...
                ('entity_type', models.CharField(choices=[('Corp', 'Corporation'), ('Dir', 'Directorate'), ('Div', 'Division'), ('Dept', 'Department'), ('Unit', 'Unit')], max_length=50)),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='Leaveapp.orgunit')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Presdir', 'President Director'), ('Director', 'Director'), ('Division Head', 'Division Head'), ('Department Head', 'Department Head'), ('Unit Head', 'Unit Head'), ('Staff', 'Staff')], max_length=50)),
                ('is_admin', models.BooleanField(default=False)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('org_unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Leaveapp.orgunit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=0, default_currency='IDR', max_digits=15)),
                ('document', models.FileField(upload_to='documents')),
                ('status', django_fsm.FSMIntegerField(choices=[(0, 'cancelled'), (1, 'created'), (2, 'rejected'), (3, 'approved by director'), (4, 'approved by President director')], default=1, protected=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='procurementapplication_createdby', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='procurementapplication_modifiedby', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'permissions': (('can_cancel', 'Can cancel'), ('can_approve_reject', 'and reject')),
            },
        ),
    ]
